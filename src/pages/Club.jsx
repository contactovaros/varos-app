...
export default function Club() {
  ...
  if (!customer) {
    return <div className="min-h-screen bg-paper pt-24 text-center text-sm text-ink/50">Cargando tu perfil del club…</div>
  }
  ...
  return (
    <div className="min-h-screen bg-paper flex flex-col items-center justify-center px-6 py-10">
      ...
      <button
        onClick={signOut}
        className="mt-8 px-6 py-3 rounded-xl text-sm font-head font-semibold border border-ink/10 text-ink/60"
      >
        Cerrar sesión
      </button>
    </div>
