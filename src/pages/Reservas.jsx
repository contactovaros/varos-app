        ...
        <>
          ...
          <div className="w-full max-w-md bg-inkSoft rounded-2xl p-3 mb-4">
            ...
            >
              ...
              {/* Comedor Exterior: mismo fondo (foto vacía, sin mesas
                  pintadas) que usa /admin/mesas, vía ComedorBackground. Las
                  mesas se dibujan siempre sobre sus coordenadas x/y reales,
                  igual que Salón/Terraza — así lo que el admin mueve/agrega/
                  saca en el editor se refleja automáticamente acá, sin un
                  mapa de posiciones aparte que haya que mantener a mano. */}
