    ...
    <div id="recibo-print" className="fixed inset-0 z-50 bg-ink/95 flex flex-col items-center justify-center px-4 print:static print:bg-white print:block print:px-0">
      ...
      <div id="recibo-boleta" className="bg-white text-black w-[80mm] max-w-full p-3 font-mono text-[11px] leading-snug print:p-2">
        <div className="text-center mb-2">
          {/* Logo arriba (pedido del usuario, 2026-09-25), en negro también en
              la vista previa: la BIXOLON es térmica y solo imprime negro, y el
              usuario quiere que la pantalla muestre lo mismo que sale en papel
              (primero se probó dorado en pantalla y lo descartó). */}
          <img src="/logo-varos-boleta.png" alt="Varo's" className="block mx-auto w-[28mm] mb-2.5" />
